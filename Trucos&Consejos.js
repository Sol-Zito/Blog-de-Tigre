let trucos = [
  ...
  },
  {
    ...
    descripcionCorta:
      "Que el dinero no sea un obstáculo: hay muchas maneras de autofinanciar un viaje.",
    consejos: [
      "Haz un presupuesto de gastos estimados de cada destino..",
      "Hazte con una tarjeta que NO cobre comisiones.",
      "Descargate una APP para saber cuál es el cambio de moneda exacto.",
      "No tengas todo el dinero en un sitio solo: deja algo de dinero de emergencia aparte (por ejemplo en la mochila/dentro un libro…).",
    ],
  },
  {
    id: 3,
    ...
    consejos: [
      "Jamás salgo a recorrer con auriculares.",
  ...
  },
  {
    ...
    descripcionCorta:
      "La idea de viajar puede parecer muy lejana. Estamos acá, para ayudarte a conseguir la información necesaria para que puedas soñar y viajar...",
    consejos: [
  ...
  },
  {
    ...
    descripcionCorta:
      "Al viajar solemos querer recorrer todo, probar y hacer cosas fuera de lo habitual, por eso, debemos ser concientes de la salud...",
    consejos: [
      "Lleva un pequeño botiquín y no una farmacia.",
      "Vacúnate cuando sea necesario y asegúrate.",
      "Lleva alochol en gel, no viene mal.",
      "Siempre lleva una botella de agua.",
      "Chocolates o snack",
    ],
  },
  {
    ...
    descripcionCorta:
      "Siempre lleva equipaje ligero, si no quieres acabar tu viaje con la misma columna vertebral que el jorobado de Notre Dame...",
    consejos: [
      "Lleva una mochila extra, para excursiones y paseos.",
      "No te olvides un candado.",
      "El Kindle se ha transformado en todo un imprescindible de nuestra mochila.",
    ],
  },
];
  ...
  cards.innerHTML += `<div class="col-sm"> <div class="card border" style="width: 20rem; height: 30rem">
   ...
   <div class="card-body">
     ...
     <p class="card-text">
      ...
      <div>
        <p>
          <button class="btn btn-primary btn-consejos" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${
            data.id
